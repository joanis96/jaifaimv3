...
<head>
    ...
    <title>Jaifaim chronologie, historique </title>
...
<body>
    ...
    <div id="container">
        ...
        <div id="clip2">
            <a href="updatecover.php" title="Changer la photo de couverture"><img src="<?php echo $row['cover_picture'] ?>"></a>
        </div>
        ...
        <div id="left-nav">
            ...
            <div class="clip1">
                ...
                <a href="updatephoto.php" title="Changer la photo de profil"><img src="<?php echo $row['profile_picture'] ?>"></a>
            </div>
